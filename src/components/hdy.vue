...
<script>
    ...
    import {isExistingFilterData, isExistingKeyword} from "../assets/js/project"
    import {init_hdy_data, viewDataHdy} from "../assets/data_handler/view_data_hdy";
    import {api_hdy_request, init_hdy_api} from "../assets/api/hdy";
    import {api_ehd_request, init_ehd_api} from "../assets/api/ehd";
